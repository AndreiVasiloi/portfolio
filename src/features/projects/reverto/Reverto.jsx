  ...
  return (
    <div className="project">
      ...
      <div className="project__gallery">
        <Gallery color={"#007965"} project="reverto" images={images} />
      </div>
      <div className="project__about">
        ...
        <p className="project__about-text">
          This was the first app build by me, and I am very proud of this. With
          the help of Reverto you can take care of your business management. My
          tool can help you to know what products you have in your inventory,
          and send you a notification if one of your product has expired. You
          can use it as an agenda for your appointments, calculate your profit
          and alot more.
        </p>
      </div>
